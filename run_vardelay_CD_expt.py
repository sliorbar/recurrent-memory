...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Recurrent Memory Experiment (Variable Delay Condition -CD)')
    ...
    generator  = generators.VarChangeDetectionTask(max_iter=25001, batch_size=50,
                                                         n_loc=1, n_in=50, n_out=1,
                                                         stim_dur=25, max_delay=100,
                                                         resp_dur=25, kappa=2.0,
                                                         spon_rate=0.1, tr_cond=tr_cond)
    test_generator = generators.VarChangeDetectionTask(max_iter=2501, batch_size=50,
                                                         n_loc=1, n_in=50, n_out=1,
                                                         stim_dur=25, max_delay=100,
                                                         resp_dur=25, kappa=2.0,
    ...
    # SAVE TRAINED MODEL
    sio.savemat('500_vardelay_CD_sigma%f_lambda%f_everything.mat' % (offdiag_val, diag_val),
