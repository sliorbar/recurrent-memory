...
if __name__ == "__main__":
    ...
    ex_inp_vec = np.reshape(ex_inp_vec,(-1, generator.stim_dur+generator.delay_dur+generator.resp_dur, (ExptDict["task"]["n_loc"]+1) * generator.n_in))

    # SAVE TRAINED MODEL
    sio.savemat('500_dynamic_sigma%f_lambda%f_model%i_task%i_everything.mat' % (offdiag_val, diag_val, m_ind, t_ind),
